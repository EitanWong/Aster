...
All 23 reference working copies were checked against their configured upstream
branches on 2026-08-21. Eight existing gitlinks advanced to the fetched branch
tips and S2-MoE was added as a new pinned research reference; all configured
branch refs are now locally fetched and pinned. The 19 `.gitmodules` entries
...
| --- | --- | --- | --- | --- |
| `Rapid-MLX` | `main` | `a8e185d31d8d79ec10f222043bc372e363ad29ed` | gitlink | Advanced; fetched 2026-08-21 |
| `lmstudio-mlx-engine` | `main` | `3b6d6145ab48332e9a21f6acc0589a369ba8ea89` | gitlink | Fetch succeeded; no branch advance |
| `uzu` | `main` | `9022ad3b69fd10f5026e1b1f2538c82d9f5754a7` | gitlink | Advanced; fetched 2026-08-21 |
| `cider` | `main` | `4d91fcee9439f7aea17ae6e965271d9536c604a0` | gitlink | Fetch succeeded; no branch advance |
| `llama.cpp` | `master` | `749f688fcaa4c472ec034b08cb8a907c45cfaa02` | gitlink | Advanced; fetched 2026-08-21 |
| `vllm-metal` | `main` | `67100ba77780dec48adeb569724efaf8fe928b19` | gitlink | Fetch succeeded; no branch advance |
...
| `vllm` | `main` | `2adf4b9e2a915bd30876ab0c5dba2243f54fe5b7` | gitlink | Advanced; fetched 2026-08-21 |
...
| `sglang` | `main` | `6127d1daeee33ec758a737bca0a1ddd2d17f02ca` | gitlink | Advanced; fetched 2026-08-21 |
...
| `mlx-lm` | `main` | `d53e70f7a3870b85a3262bdab10999ada307ffc8` | gitlink | Advanced; fetched 2026-08-21 |
| `mlx-swift-lm` | `main` | `130e3f0cd68e120019b0864c390d0309b0ec5618` | gitlink | Advanced; fetched 2026-08-21 |
| `SpecForge` | `main` | `de0ea2f5de78e306e916bd58162932a2ea1dcc77` | gitlink | Advanced; fetched 2026-08-21 |
| `S2-MoE` | `orin` | `fba914c3455403f0de2b50be3faeba0a4195e0f6` | gitlink | Added from the author repository; MIT; fetched 2026-08-21 |
