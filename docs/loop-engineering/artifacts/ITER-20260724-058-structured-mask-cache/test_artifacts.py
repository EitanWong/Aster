...
FORMAL_RESULTS = (
    ("strict-short-b4-r18", "structured-b4", 409, 1_152),
    ("strict-long-b2-r18", "structured-b2", 24_601, 288),
)
...
def test_formal_matrices_pass_source_bound_admission() -> None:
    for result_name, cell_name, prompt_tokens, expected_misses in FORMAL_RESULTS:
        ...
        for record in records:
            ...
            assert payload["policy_metrics"]["baseline"]["forced_mask_misses"] == expected_misses
            assert payload["policy_metrics"]["production"]["forced_mask_misses"] == 0
